---
date: "2026-01-15T16:12:00+03:00"
title: "Suorakulmiot ja ellipsit"
layout: default
nav_order: 5
parent: Perusteet
---

# Suorakulmiot ja ellipsit
...
Suorakulmio piirretään painamalla hiiren nappi pohjaan, raahaamalla ja päästämällä
nappi ylös. Pohjaan painaminen luo suorakulmiolle yhden kulman ja ylös päästäminen
sen vastakkaisen kulman. Suorakulmio muodostuu näiden väliin vaaka- ja pystysuorien,
toisiaan vastaan kohtisuorien sivujen muodostamana kuviona. Jos suorakulmion
...
aloituspisteestä tuleekin suorakulmion keskipiste ja piirtäminen tapahtuu sen
ympärille.

## Neliö

Neliö on suorakulmion erikoistapaus, jossa kaikki sivut ovat saman pituiset.
Neliö piirretään samalla työkalulla, mutta pitämällä *ctrl*-näppäin pohjassa.
Tämä lukitsee suorakulmion pysty- ja vaakasuunnan mittasuhteet
kokonaisluvuiksi taikka kultaisen leikkauksen suhteeksi. Tällä tavoin voidaan siis
piirtää neliön lisäksi myös suorakulmioita, joiden mittasuhteet ovat esimerkiksi:
...
Suorakulmion koon ja muodon muuttamiseen käytettävien "kahvojen" lisäksi suorakulmion
yhdessä kulmassa näkyy ympyrän muotoinen kahva. Tätä raahaamalla suorakulmion
kulman voi pyöristää. Mitä kauemmas kuvion kulmasta ympyrän raahaa, sitä suurempi
...
arvojen esittämiseen käytetty mittayksikkö. Lisäksi siellä on kulmanpyöristyksen
nollaava nappi.
...
säätää ellipsityökalulla. Näistä kahvoista skaalaamalla ellipsin keskipiste
pysyy paikoillaan ja se venyy symmetrisesti. Eli esimerkiksi, jos ellipsiä venyttää
vasemmalla olevasta neliökahvasta, se venyy samaan aikaan sekä vasemmalle että
oikealle.
...
Ellipsin kehän ja sisäpuolen värit määräytyvät samoin kuin suorakaiteella.
...
kahva, josta kaaren alku- ja loppupäätä voidaan siirtää erikseen. Se, onko lopputulos
kaari vai sektori, määräytyy sillä, päästetäänkö kahvasta irti, kun raahaava hiiri on
ellipsin kehän sisä- vai ulkopuolella. Jos irti päästäminen tapahtuu sisäpuolella,
...
Kuvion tyypin voi vaihtaa sektoriksi, kaareksi, kaarta vastaavaksi suljetuksi kuvioksi
